...
export function RunRow({ task, now }: RunRowProps) {
  ...
  return (
    <NavLink
      ...
      className="group grid grid-cols-[minmax(0,0.9fr)_minmax(0,1.4fr)_64px] items-center gap-3 border-cyanotype-rule border-t px-4 py-2.5 transition-colors duration-150 first:border-t-0 hover:bg-cyanotype-hover md:grid-cols-[236px_minmax(0,1fr)_240px_72px_64px] md:gap-4"
    >
      ...
      <span className="hidden text-right text-[11px] text-cyanotype-muted tabular-nums leading-[14px] md:block">
