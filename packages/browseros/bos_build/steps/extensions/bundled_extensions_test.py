...
class BundledExtensionsManifestTest(unittest.TestCase):
    ...
    def test_manifest_url_uses_run_scoped_override(self) -> None:
        manifest_url = (
            "https://cdn.browseros.com/release-plans/run-123/bundled-manifest.xml"
        )
        with patch.dict(
            os.environ,
            ...
            self.assertEqual(manifest_url, ctx.get_extensions_manifest_url())
