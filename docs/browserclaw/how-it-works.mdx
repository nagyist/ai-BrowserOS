...
<Steps>
  ...
  <Step title="Connect BrowserOS neo to your AI">
    ...
    <Tip>
    Using an AI tool that isn't listed? Copy the endpoint URL at the top of the page and paste it into your AI's own settings. See the [Connect page](/browserclaw/mcp/index) for the manual setup.
    </Tip>
  </Step>
