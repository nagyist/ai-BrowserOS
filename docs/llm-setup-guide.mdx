...
description: "BrowserOS works best with your own API keys or local models!"
---
...
## Option #1: Bring your own keys to ChatGPT, Gemini, Claude or other models with openrouter!
